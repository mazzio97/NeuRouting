...
parser.add_argument('-c', '--n_customers', type=int, required=False)
...
parser.add_argument('-t', '--time_limit', type=int, required=False)
...
if __name__ == "__main__":
    ...
    stats = evaluator.compare(eval_instances, n_runs=args.runs,
